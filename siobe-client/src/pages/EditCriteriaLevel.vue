<template>
    <NavRubrics>
        <template #header>
            <h2 class="font-bold text-xl text-gray-800 leading-tight">Edit Criteria Level: numquam voluptate qui</h2>
        ...
        <div style="margin-top: 2%; margin-left: 10%;">
            ...
            <router-link v-slot="{ href, isActive, navigate }" to="/createcriterialevel" custom>
                <ResponsiveNavLink :href="href" :active="isActive" @click="navigate"> > aperiam numquam nesciunt
                </ResponsiveNavLink>
            </router-link>
        </div>
            ...
            <div class="row">
                <div class="row">
                    <div class="col" style="margin-top: 3%">
                        ...
                        <div>
                            <input type="text" name="title" placeholder="Title" class="input input-bordered text-gray-500 select-bordered w-full max-w-xs rounded-md"/>
                        </div>
                    </div> 
                </div>
                ...
                <div class="row">
                    <div class="col" style="margin-top: 3%">
                        ...
                        <div>
                            <textarea class="textarea textarea-bordered text-gray-500 select-bordered w-full h-64 rounded-md" placeholder="Description" name="description"/>
                        </div>
                    </div>
                </div>
