                                ...
                                <div class="pb-8">
                                    <div class="flex flex-row sm:justify-end mb-3 px-4 sm:px-0 -mr-2 sm:-mr-3">
                                        <div class="order-5 sm:order-6 mr-2 sm:mr-3">
                                            <a href="/studyprograms/create"
                                                ...
                                                <span class="pr-1"><i class="fa fa-plus"></i> Create New Study Program</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="mb-5 overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative">
                                        <table class="border-collapse table-auto w-full bg-white table-striped relative">
                                            ...
                                            <tbody>
                                                <tr v-for="(item, index) in studyprograms" :key="index">
                                                    ...
                                                    <td class="text-gray-600 px-6 py-3 border-t border-gray-100">
                                                        <a :href="`studyprograms/show/${item.id}`"
                                                    ...
                                                    <td class="text-gray-600 px-6 py-3 border-t border-gray-100">
                                                        <div class="flex flex-wrap space-x-4">
                                                            ...
                                                            <form method="POST" action="">
                                                                ...
                                                                <button class="text-red-500" @click="deleteStudyProgram(item.id)">
                                                                    Delete
                                                                </button>
                                                            </form>
                                                        </div>
...
export default {
  ...
  methods: {
    getStudyProgram() {
      axios
        .get("http://localhost:8000/api/study-programs", {
        })
        .then((response) => {
    ...
    deleteStudyProgram(id) {
      if (confirm("Hapus Study Program?")) {
        axios
          .delete(`http://localhost:8000/api/study-programs/${id}`, {
          })
          .then((response) => {
